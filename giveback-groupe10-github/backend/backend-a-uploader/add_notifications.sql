-- =========================================================
-- Système de notifications : prévient l'auteur d'une publication
-- quand quelqu'un la like ou la commente.
-- =========================================================

create table notifications (
  id bigint generated always as identity primary key,
  user_id uuid references auth.users on delete cascade,  -- destinataire
  type text,                                               -- 'like' ou 'comment'
...
-- Notification automatique à chaque like
...
-- Notification automatique à chaque commentaire
